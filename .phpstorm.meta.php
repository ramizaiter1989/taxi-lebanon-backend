...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\lenovo\Downloads\women taxi backend\womenTaxi\public\storage' => 'string',
            ...
            'services.twilio.sms_from' => 'string',
            'services.vonage.key' => 'string',
            'services.vonage.secret' => 'string',
            'services.vonage.from' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\lenovo\\Downloads\\women taxi backend\\womenTaxi\\public\\storage','firebase.default','firebase.projects.app.credentials','firebase.projects.app.auth.tenant_id',
...
'firebase.credentials','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.twilio.token','services.twilio.sms_from','services.vonage.key','services.vonage.secret','services.vonage.from',
...
'session.partitioned','boost.enabled','boost.browser_logs_watcher','cashier.key','cashier.secret',
...
'cashier.logger','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port','reverb.servers.reverb.path',
...
'reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'boost.browser-logs','cashier.payment','cashier.webhook','sanctum.csrf-cookie','verification.verify','dashboard','profile.edit',
'profile.update','profile.destroy','passenger.map','passenger.ride.store','passenger.rides',
'passenger.profile','passenger.updateProfile','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','admin.dashboard','admin.users.index','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.drivers.index','admin.drivers.edit','admin.drivers.update',
'admin.drivers.destroy','admin.drivers.toggleLock','admin.rides.index','admin.rides.show','admin.rides.update',
'admin.rides.destroy','admin.passengers.index','admin.passengers.edit','admin.passengers.update','admin.passengers.destroy',
'admin.passengers.lock','admin.passengers.unlock','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.drivers.edit','admin.drivers.index','admin.passengers.edit','admin.passengers.index',
'admin.rides.index','admin.rides.show','admin.users.edit','admin.users.index','auth.complete-profile',
'auth.confirm-password','auth.forgot-password','auth.login','auth.otp-verifification','auth.register',
...
'dashboard','emails.verify-code','fare-estimator','layouts','layouts.app',
'layouts.guest','layouts.navigation','passenger.map','passenger.profile','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','rides.myrides','welcome',
'welcomee','cashier::invoice','cashier::payment','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.lenovo.Downloads.women taxi backend.womenTaxi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'VITE_APP_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
'SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','FIREBASE_CREDENTIALS',
'ORS_API_KEY','USE_OSRM','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
...
'TWILIO_SID','TWILIO_TOKEN','TWILIO_SMS_FROM','VONAGE_KEY','VONAGE_SECRET',
'VONAGE_FROM','MAIL_MAILER','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME',
'QUEUE_CONNECTION','WHATSAPP_NUMBER','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','REVERB_SERVER_HOST','REVERB_SERVER_PORT',
'STRIPE_KEY','STRIPE_SECRET','BROADCAST_DRIVER','PUSHER_APP_ID','PUSHER_APP_KEY',
'PUSHER_APP_SECRET','PUSHER_APP_CLUSTER','PUSHER_APP_USE_TLS','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_SECRET',
