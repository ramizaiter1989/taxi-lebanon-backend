...
class RideController extends Controller
{
    ...
    public function acceptRide(Request $request, Ride $ride)
    {
        ...
        try {
            ...
            // ✅ SINGLE notification (handles both database + push)
    ...
    // POST /api/rides/{ride}/start - Start ride
    ...
    public function cancelRide(Request $request, Ride $ride)
    {
        ...
        try {
            ...
            // ✅ SINGLE notification to the other party
    ...
    // GET /api/rides/live - Current active ride
